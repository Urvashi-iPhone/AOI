...
//#define BASE_URL @"http://rdso.in/msetcl/public/"

#define BASE_URL @"http://192.168.0.105/laravel/MSETCL/project/public/"
...
#define DEF_USER_PROFILE @"def_user_profile"
...
//Start Employees Assign Issues List

#define URL_START_EMP_ISSUES @"api/v1/start_employee_assign_issue"
...
#define URL_CONTRACTOR_DASHBOARD @"api/v1/contractor/dashboard"

///Contractor Get Project Issue
#define URL_GET_PROJECT_ISSUE @"api/v1/project/issue/"

//Contractor Issue Hold Submit
#define URL_ISSUE_HOLD_SUBMIT @"api/v1/issue/contractor_issue_hold_submit"

//Employee Chat
#define URL_HOLD_ISSUE_CHAT @"api/v1/issue/hold_issue_chat_details/"

//Get Employees Below Level Projects
#define URL_GET_EMP_BELOW_LEVEL_PROJECT @"api/v1/project/below_level_project"


//Get Employees Below Level Projects
#define URL_GET_EMPLOYEE_PROJECT @"api/v1/project/my_project"
