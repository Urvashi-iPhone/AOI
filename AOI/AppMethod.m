...
//NSString *htmlString = pathDetailModel.data.terms;
//
//
//
...
{
    UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"GetUMoney" message:msg delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
    [alert show];
}
